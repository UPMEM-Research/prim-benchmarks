...
typedef struct Params {
    unsigned int  m_size;   //Row size
    unsigned int  n_size;   //Column size
    unsigned int  n_warmup; //Data-warmup iteration
    unsigned int  n_reps;   //Mat-Vec multiplication iteration
}Params;
